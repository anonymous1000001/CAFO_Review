...
def setup_neptune_logger(cfg: DictConfig, tags: list = None):
    ...
    neptune_logger.experiment["parameters/server"] = cfg.server_name
    ...
    if cfg.loss.name in ["opl", "orthoregularizer"]:
        neptune_logger.experiment["parameters/loss_type"] = cfg.loss.name
        neptune_logger.experiment["parameters/loss_gamma"] = cfg.loss.gamma
