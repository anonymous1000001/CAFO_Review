...
def main(cfg: DictConfig) -> None:
    ...
    if cfg.task.task_name in ["gilon_activity", "gilon_bodyweight", "gilon_speed"]:
        ...
        log.info(f"Setting up UEA Dataset with CV number {cfg.task.validation_cv_num}")
    ...
    if cfg.lightning_model in [
        "lightning_model_reg_cafo_recbam",
        "lightning_model_cafo_recbam",
    ]:
    ...
    if cfg.lightning_model in [
        ...
        print("saved global and classwise attention!")
